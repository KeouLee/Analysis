...
Modified CP2K source code implementing the rotational constraint, developed by @jtyang-chem and reproduced here for convenience. For details, see https://doi.org/10.1063/5.0216913.
